...
<body>
    ...
    if ($store_hours->is_open()) {
        echo "<strong class='open'>Yes, we're open! Today's hours are: <br>" . $store_hours->hours_today() . "</strong>";
    } else {
        echo "<strong class='closed'>Sorry, we're closed. Today's hours are: <br>" . $store_hours->hours_today() . "</strong>";
    }
